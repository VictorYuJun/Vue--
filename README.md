# 这是一个仿照当下一些流行移动web模块的综合项目

## 项目描述
1.使用Vue作为项目框架，webpack作为项目架构工具
2.开发过程中使用大量的路由设置组件之间的切换
3.并通过vue-resource实现先后端数据交互
4.样式选择用sass进行编辑，方便直观
5.外部组件使用Mint-UI和MUI混合开发
...
3. 新版本的插件由于和老版本插件出入较大目前还未完成显示页图片大小的设置，正在解决中
